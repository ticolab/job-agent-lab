...
``src/job_agent_lab/extraction/dom/assets/collect_links.js``, kept in
...
from job_agent_lab.domain.company import Company, TalentbrewConfig
    ...
    *,
    ...
    Args:
        ...
        min_depth: The company's ``LinkRule.min_depth`` (default 1,
            ...
            :class:`~job_agent_lab.domain.company.LinkRule`). Applied
