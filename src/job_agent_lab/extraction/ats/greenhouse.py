...
:class:`~job_agent_lab.extraction.dom.strategy.DomStrategy`, authored by
...
:meth:`~job_agent_lab.domain.region.TargetRegion.matches` — no
...
def board_token(company: Company) -> str:
    ...
    *braces* (see
    :meth:`job_agent_lab.domain.company.Company._validate_greenhouse_host`).
