...
- :class:`~job_agent_lab.extraction.dom.strategy.DomStrategy` — the
  browser-use agent + deterministic in-page matcher pipeline (default).
- :class:`~job_agent_lab.extraction.ats.greenhouse.GreenhouseStrategy` —
  the Greenhouse job-boards API adapter.
- :class:`~job_agent_lab.extraction.ats.phenom.PhenomStrategy` — the
...
- :class:`~job_agent_lab.extraction.ats.talentbrew.TalentbrewStrategy`
...
- :class:`~job_agent_lab.extraction.ats.coveo.CoveoStrategy` — the
...
- :class:`~job_agent_lab.extraction.ats.bamboohr.BambooHrStrategy` —
...
mutating :data:`~job_agent_lab.extraction.base.STRATEGIES` on import)
...
from job_agent_lab.extraction.ats.bamboohr import BambooHrStrategy
...
from job_agent_lab.extraction.ats.peopleforce import PeopleForceStrategy
...
from job_agent_lab.extraction.base import STRATEGIES
