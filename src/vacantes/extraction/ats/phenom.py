...
request, filters by :meth:`~vacantes.domain.region.TargetRegion.matches`,
...
:data:`~vacantes.domain.region.COSTA_RICA_LATAM`). Deliberately not
...
from vacantes.domain.company import Company, PhenomConfig
...
def slugify_title(title: str) -> str:
    ...
    :func:`vacantes.catalog.slugify`, which lowercases and exists
