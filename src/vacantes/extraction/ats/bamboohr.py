...
:meth:`~vacantes.domain.region.TargetRegion.matches` — no rendered
...
:mod:`~vacantes.extraction.ats.greenhouse`:
...
def board_origin(company: Company) -> str:
    ...
    *braces* (see
    :meth:`vacantes.domain.company.Company._validate_bamboohr_host`).
